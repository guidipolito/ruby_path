...
class AboutSymbols < Neo::Koan
  ...
  def test_symbols_do_not_have_string_methods
    symbol = :not_a_string
    # I think respond_to? is a check for a method in the Object 
    # since method_names are symbol and strings can't compare with symbol 
    # we pass a symbol to test
  ...
  def test_symbols_cannot_be_concatenated
    ...
    assert_raise(NoMethodError) do
      :cats + :dogs # seems like concatenation with + is actually a method instead of the default operation
    end
  end
